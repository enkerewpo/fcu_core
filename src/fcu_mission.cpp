...
float pos_odom_001_x = 0.0f;
float pos_odom_001_y = 0.0f;
float pos_odom_001_z = 0.0f;
float pos_odom_002_x = 0.0f;
float pos_odom_002_y = 0.0f;
float pos_odom_002_z = 0.0f;
float pos_odom_003_x = 0.0f;
float pos_odom_003_y = 0.0f;
float pos_odom_003_z = 0.0f;
float pos_odom_004_x = 0.0f;
float pos_odom_004_y = 0.0f;
float pos_odom_004_z = 0.0f;
float pos_odom_005_x = 0.0f;
float pos_odom_005_y = 0.0f;
float pos_odom_005_z = 0.0f;
float pos_odom_006_x = 0.0f;
float pos_odom_006_y = 0.0f;
float pos_odom_006_z = 0.0f;

float pos_takeoff_001_x = 0.0f;
float pos_takeoff_001_y = 0.0f;
float pos_takeoff_001_z = 0.0f;
float pos_takeoff_002_x = 0.0f;
float pos_takeoff_002_y = 0.0f;
float pos_takeoff_002_z = 0.0f;
float pos_takeoff_003_x = 0.0f;
float pos_takeoff_003_y = 0.0f;
float pos_takeoff_003_z = 0.0f;
float pos_takeoff_004_x = 0.0f;
float pos_takeoff_004_y = 0.0f;
float pos_takeoff_004_z = 0.0f;
float pos_takeoff_005_x = 0.0f;
float pos_takeoff_005_y = 0.0f;
float pos_takeoff_005_z = 0.0f;
float pos_takeoff_006_x = 0.0f;
float pos_takeoff_006_y = 0.0f;
float pos_takeoff_006_z = 0.0f;

void cmdHandler(const std_msgs::Int16::ConstPtr &cmd) {
  switch (cmd->data) {
  case 3: //起飞时刻记录坐标,原地悬停
    pos_takeoff_001_x = pos_odom_001_x;
    pos_takeoff_001_y = pos_odom_001_y;
    pos_takeoff_001_z = pos_odom_001_z;
    pos_takeoff_002_x = pos_odom_002_x;
    pos_takeoff_002_y = pos_odom_002_y;
    pos_takeoff_002_z = pos_odom_002_z;
    pos_takeoff_003_x = pos_odom_003_x;
    pos_takeoff_003_y = pos_odom_003_y;
    pos_takeoff_003_z = pos_odom_003_z;
    pos_takeoff_004_x = pos_odom_004_x;
    pos_takeoff_004_y = pos_odom_004_y;
    pos_takeoff_004_z = pos_odom_004_z;
    pos_takeoff_005_x = pos_odom_005_x;
    pos_takeoff_005_y = pos_odom_005_y;
    pos_takeoff_005_z = pos_odom_005_z;
    pos_takeoff_006_x = pos_odom_006_x;
    pos_takeoff_006_y = pos_odom_006_y;
    pos_takeoff_006_z = pos_odom_006_z;
    break;
  case 5:
    enable_track = true;
    break;
...
static float px1 = 0.0f, py1 = 0.0f, pz1 = 0.0f, px2 = 0.0f, py2 = 0.0f,
             pz2 = 0.0f, px3 = 0.0f, py3 = 0.0f, pz3 = 0.0f, px4 = 0.0f,
             py4 = 0.0f, pz4 = 0.0f, px5 = 0.0f, py5 = 0.0f, pz5 = 0.0f,
...
void execute_mission_001(void) {
  ...
  if (enable_track) {
    ...
    case 1:
      ...
      px1 = pos_takeoff_001_x + px;
      py1 = pos_takeoff_001_y + py;
      pz1 = pz;
      px2 = pos_takeoff_002_x + px;
      py2 = pos_takeoff_002_y + py;
      pz2 = pz;
      px3 = pos_takeoff_003_x + px;
      py3 = pos_takeoff_003_y + py;
      pz3 = pz;
      px4 = pos_takeoff_004_x + px;
      py4 = pos_takeoff_004_y + py;
      pz4 = pz;
      px5 = pos_takeoff_005_x + px;
      py5 = pos_takeoff_005_y + py;
      pz5 = pz;
      px6 = pos_takeoff_006_x + px;
      py6 = pos_takeoff_006_y + py;
      pz6 = pz;
    ...
    case 4:
      ...
      break;
    default:
      px1 = pos_takeoff_001_x;
      py1 = pos_takeoff_001_y;
      pz1 = 0.0f;
      px2 = pos_takeoff_002_x;
      py2 = pos_takeoff_002_y;
      pz2 = 0.0f;
      px3 = pos_takeoff_003_x;
      py3 = pos_takeoff_003_y;
      pz3 = 0.0f;
      px4 = pos_takeoff_004_x;
      py4 = pos_takeoff_004_y;
      pz4 = 0.0f;
      px5 = pos_takeoff_005_x;
      py5 = pos_takeoff_005_y;
      pz5 = 0.0f;
      px6 = pos_takeoff_006_x;
      py6 = pos_takeoff_006_y;
      pz6 = 0.0f;
      break;
    }
  }
...
void pos_cmd_handler(const quadrotor_msgs::PositionCommand::ConstPtr
                         &pose_plan) //仅机载电脑运行此函数
{
  //发布mission
  get_pos_cmd = true;
  mission_001.header.frame_id = "mission_001";
...
int main(int argc, char **argv) {
  ...
  ros::NodeHandle nh;
  ros::Subscriber comm =
      nh.subscribe<std_msgs::Int16>("/fcu_bridge/command", 100, cmdHandler);
  ros::Subscriber odom001 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_001", 100, odom_global001_handler);
  ros::Subscriber odom002 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_002", 100, odom_global002_handler);
  ros::Subscriber odom003 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_003", 100, odom_global003_handler);
  ros::Subscriber odom004 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_004", 100, odom_global004_handler);
  ros::Subscriber odom005 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_005", 100, odom_global005_handler);
  ros::Subscriber odom006 = nh.subscribe<nav_msgs::Odometry>(
      "odom_global_006", 100, odom_global006_handler);
  ros::Subscriber pos_cmd = nh.subscribe<quadrotor_msgs::PositionCommand>(
      "planning/pos_cmd", 100, pos_cmd_handler);

  mission_pub_001 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_001", 100);
  mission_pub_002 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_002", 100);
  mission_pub_003 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_003", 100);
  mission_pub_004 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_004", 100);
  mission_pub_005 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_005", 100);
  mission_pub_006 = nh.advertise<geometry_msgs::InertiaStamped>(
      "/fcu_bridge/mission_006", 100);
  ...
  while (ros::ok()) {
    ...
    br.sendTransform(
        tf::StampedTransform(transform, ros::Time::now(), "map", "uwb"));
    q.setRPY(0, 0, 0);
    transform.setRotation(q);
    br.sendTransform(
